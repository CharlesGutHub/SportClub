    ...
    public static void importData() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(csvPath));
            ...
            while ((line = br.readLine()) != null) {
                ...
                pstmt.setInt(7, safeParseInt(data, 9));  // F 1-4 ans
                pstmt.setInt(8, safeParseInt(data, 10)); // F 5-9 ans
                pstmt.setInt(9, safeParseInt(data, 11)); // F 10-14 ans
                pstmt.setInt(10, safeParseInt(data, 12)); // F 15-19 ans
                pstmt.setInt(11, safeParseInt(data, 13) + safeParseInt(data, 14)); // F 20-29 ans
                pstmt.setInt(12, safeParseInt(data, 15) + safeParseInt(data, 16)); // F 30-44 ans
                pstmt.setInt(13, safeParseInt(data, 17) + safeParseInt(data, 18)); // F 45-59 ans
                pstmt.setInt(14, safeParseInt(data, 19) + safeParseInt(data, 20) + safeParseInt(data, 21)); // F 60-74 ans
                pstmt.setInt(15, safeParseInt(data, 22) + safeParseInt(data, 23)); // F 75+ ans
